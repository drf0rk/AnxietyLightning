# /content/ANXETY/scripts/gradio_setup_ui.py (v6.1 - Ultimate Lazy Load)
...
with gr.Blocks(theme=gr.themes.Soft(), css=MODERN_LOG_CSS) as demo:
    ...
    def update_asset_choices(is_sdxl):
        logger.info(f"Dynamically loading choices for is_sdxl={is_sdxl}")
        ...
        loras = list(loras_data.get('lora_data', {}).get('sdxl_loras' if is_sdxl else 'sd15_loras', {}).keys())
...
if __name__ == "__main__":
    ...
    # Launch the app. This will now return instantly.
