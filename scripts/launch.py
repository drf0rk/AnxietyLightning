# /content/ANXETY/scripts/launch.py (v12 - Refactored for Stability)
...
if __name__ == '__main__':
    ...
    tunnels_to_launch.append({
        'name': 'Gradio',
        'cmd': f"python3 -m gradio.tunneling {tunnel_port}",
        'log_file': gradio_log,
    ...
    for tunnel in tunnels_to_launch:
        print(f"🚀 Launching {tunnel['name']} tunnel in background... (Log: {tunnel['log_file']})")
