...
class AnxietyUI:
    ...
    def _on_install_extension_clicked(self, b):
        ...
        with self.layouts['output_layout']:
            ...
            if not repo_url or not repo_url.startswith('http'):
                print("❌ Please enter a valid Git repository URL."); return
            print(f"🔧 Cloning extension from: {repo_url}...")
            HOME = Path(js.read(SETTINGS_PATH, 'ENVIRONMENT.home_path', '/content'))
            ...
            try:
                ...
                print(f"✅ Successfully cloned '{repo_name}'."); self.widgets['extension_url_input'].value = ""
    ...
    def save_settings(self):
        ...
        # --- THIS IS THE FIX ---
        # Instead of using Path.home(), we hardcode the correct path for the Colab environment.
